...
public final class CombineSegmentBreakpointsIntegrationTest extends CommandLineProgramTest {
    ...
    private static final String GROUND_TRUTH_SEGMENTS_FILE = TEST_SUB_DIR + "combine-segment-breakpoints-comparison.tsv";
    private static final String GROUND_TRUTH_SEGMENTS_FILE_NO_SAMHEADER = TEST_SUB_DIR + "combine-segment-breakpoints-comparison-no-samheader.tsv";
    private static final String INPUT_SEGMENTS_FILE_WITH_DIFFERENT_HEADERS = TEST_SUB_DIR + "combine-segment-breakpoints-different-annotation-headers.tsv";
    ...
    private void runCombineSegmentBreakpoints(final String file1, final String file2, final File outputFile, final String refFile) {
        ...
        arguments.add(file2);
        arguments.add("--" + CombineSegmentBreakpoints.COLUMNS_OF_INTEREST_LONG_NAME);
        arguments.add(SEGMENT_CALL_1);
        arguments.add("--" + CombineSegmentBreakpoints.COLUMNS_OF_INTEREST_LONG_NAME);
        arguments.add(SEGMENT_MEAN_1);
        arguments.add("--" + CombineSegmentBreakpoints.COLUMNS_OF_INTEREST_LONG_NAME);
        arguments.add(SEGMENT_CALL_2);
        arguments.add("--" + CombineSegmentBreakpoints.COLUMNS_OF_INTEREST_LONG_NAME);
        arguments.add(SEGMENT_MEAN_2);
        arguments.add("-" + StandardArgumentDefinitions.OUTPUT_SHORT_NAME);
        arguments.add(outputFile.getAbsolutePath());
        if (refFile != null) {
            arguments.add("-" + StandardArgumentDefinitions.REFERENCE_SHORT_NAME);
