...
public class LearnHyperparametersEngine {
    ...
    public static double[] computeLog10Responsibilities(final Nucleotide refAllele, final Nucleotide altAllele,
        ...
        for (State z : State.values()){
            ...
            if (State.artifactStates.contains(z) && State.getAltAlleleOfArtifact(z) != altAllele) {
    ...
    private static List<Pair<Double, Double>> getPseudoCountsForAlleleFraction(){
        final List<Pair<Double, Double>> alleleFractionPseudoCounts = new ArrayList<>(State.values().length);
    ...
    private static List<Pair<Double, Double>> getPseudoCountsForAltF1R2Fraction(){
        final List<Pair<Double, Double>> altF1R2FractionPseudoCounts = new ArrayList<>(State.values().length);
    ...
    public enum State {
        ...
        public static Nucleotide getAltAlleleOfArtifact(final State z){
        ...
        public static State getF1R2StateOfInterest(final Nucleotide altAllele) {
            switch (altAllele) {
                case A:
                    return State.F1R2_A;
                case C:
        ...
        public static State getF2R1StateOfInterest(final Nucleotide altAllele) {
            switch (altAllele) {
                case A:
                    return State.F2R1_A;
                case C:
